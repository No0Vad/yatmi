    ...
    public class Subscriptions : TestBase
    {
        ...
        public async Task OnSubscribe(string tierLevel, SubPlanTypes subPlan, int ircCode)
        {
            ...
            await _client.SimulateMessagesAsync(
                ...
                $"id={GUID};login={DUMMY_USERNAME};mod=0;msg-id=sub;msg-param-cumulative-months=1;" +
                ...
                $"user-id=000000000;user-type= :tmi.twitch.tv {KnownCommands.USERNOTICE} #{DUMMY_CHANNEL}"
            );
        ...
        public async Task OnSubscribePrime()
        {
            ...
            await _client.SimulateMessagesAsync(
                $"@badge-info=subscriber/0;badges=subscriber/0;color=;display-name={DUMMY_USERNAME};emotes=;flags=;" +
                $"id={GUID};login={DUMMY_USERNAME};mod=0;msg-id=sub;msg-param-cumulative-months=1;msg-param-goal-contribution-type=SUB_POINTS;" +
                ...
                $@"system-msg={DUMMY_USERNAME}\ssubscribed\swith\sPrime.;tmi-sent-ts=1654696969696;user-id=000000000;user-type= :tmi.twitch.tv {KnownCommands.USERNOTICE} #{DUMMY_CHANNEL}"
            );
        ...
        public async Task OnResubscribe(string tierLevel, SubPlanTypes subPlan, int ircCode)
        {
            ...
            await _client.SimulateMessagesAsync(
                ...
                $"id={GUID};login={DUMMY_USERNAME};mod=0;msg-id=resub;msg-param-cumulative-months=16;msg-param-months=0;msg-param-multimonth-duration=0;" +
                ...
                $"user-id=00000000;user-type= :tmi.twitch.tv {KnownCommands.USERNOTICE} #{DUMMY_CHANNEL} :Hello World!"
            );
        ...
        public async Task OnResubscribePrime()
        {
            ...
            await _client.SimulateMessagesAsync(
                ...
                $"id={GUID};login={DUMMY_USERNAME};mod=0;msg-id=resub;msg-param-cumulative-months=23;msg-param-months=0;msg-param-multimonth-duration=0;" +
                ...
                $"tmi-sent-ts=1654696969696;user-id=000000000;user-type= :tmi.twitch.tv {KnownCommands.USERNOTICE} #{DUMMY_CHANNEL} :Hello World!"
            );
        ...
        public async Task OnGiftSubscription(string tierLevel, SubPlanTypes subPlan, int ircCode)
        {
            ...
            await _client.SimulateMessagesAsync(
                $"@badge-info=subscriber/12;badges=subscriber/12;color=#121212;display-name={DUMMY_USERNAME};emotes=;flags=;id={GUID};" +
                ...
                $@"system-msg={DUMMY_USERNAME}\sgifted\sa\sTier\s{tierLevel}\ssub\sto\s{DUMMY_USERNAME}_Foobar!\sThey\shave\sgiven\s50\sGift\sSubs\sin\sthe\schannel!;tmi-sent-ts=1654696969696;user-id=00000000;" +
        ...
        public async Task OnGiftSubscription_Anonymous(string tierLevel, SubPlanTypes subPlan, int ircCode)
        {
            ...
            await _client.SimulateMessagesAsync(
                "@badge-info=;badges=;color=;display-name=AnAnonymousGifter;emotes=;flags=;id={GUID};" +
                "login=ananonymousgifter;mod=0;msg-id=subgift;msg-param-fun-string=FunStringFive;msg-param-gift-months=1;msg-param-months=11;" +
                ...
                @$"subscriber=0;system-msg=An\sanonymous\suser\sgifted\sa\sTier\s{tierLevel}\ssub\sto\s{DUMMY_USERNAME}!\s;tmi-sent-ts=1654696969696;user-id=000000000;user-type= :tmi.twitch.tv {KnownCommands.USERNOTICE} #{DUMMY_CHANNEL}"
            );
        ...
        public async Task OnCommunityGiftSubscription(string tierLevel, SubPlanTypes subPlan, int ircCode)
        {
            ...
            await _client.SimulateMessagesAsync(
                $@"@badge-info=founder/31;badges=founder/0;color=#121212;display-name={DUMMY_USERNAME};emotes=;flags=;id={GUID};login={DUMMY_USERNAME};mod=0;msg-id=submysterygift;msg-param-goal-contribution-type=SUB_POINTS;msg-param-goal-current-contributions=497;msg-param-goal-description=nice;msg-param-goal-target-contributions=699;msg-param-goal-user-contributions=5;msg-param-mass-gift-count=5;msg-param-origin-id=00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00;msg-param-sender-count=123;msg-param-sub-plan={ircCode};room-id=00000000;subscriber=1;system-msg={DUMMY_USERNAME}\sis\sgifting\s5\sTier\s{tierLevel}\sSubs\sto\sPOG's\scommunity!\sThey've\sgifted\sa\stotal\sof\s123\sin\sthe\schannel!;tmi-sent-ts=1654696969696;user-id=00000000;user-type= :tmi.twitch.tv {KnownCommands.USERNOTICE} #{DUMMY_CHANNEL}",
                $@"@badge-info=founder/31;badges=founder/0;color=#121212;display-name={DUMMY_USERNAME};emotes=;flags=;id={GUID};login={DUMMY_USERNAME};mod=0;msg-id=subgift;msg-param-gift-months=1;msg-param-months=2;msg-param-origin-id=00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00;msg-param-recipient-display-name={DUMMY_USERNAME}_A;msg-param-recipient-id=000000000;msg-param-recipient-user-name={DUMMY_USERNAME}_A;msg-param-sender-count=0;msg-param-sub-plan-name=Channel\sSubscription\sPOG;msg-param-sub-plan={ircCode};room-id=00000000;subscriber=1;system-msg={DUMMY_USERNAME}\sgifted\sa\sTier\s{tierLevel}\ssub\sto\s{DUMMY_USERNAME}_A!;tmi-sent-ts=1654696969696;user-id=00000000;user-type= :tmi.twitch.tv {KnownCommands.USERNOTICE} #{DUMMY_CHANNEL}",
                $@"@badge-info=founder/31;badges=founder/0;color=#121212;display-name={DUMMY_USERNAME};emotes=;flags=;id={GUID};login={DUMMY_USERNAME};mod=0;msg-id=subgift;msg-param-gift-months=1;msg-param-months=5;msg-param-origin-id=00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00;msg-param-recipient-display-name={DUMMY_USERNAME}_B;msg-param-recipient-id=000000000;msg-param-recipient-user-name={DUMMY_USERNAME}_B;msg-param-sender-count=0;msg-param-sub-plan-name=Channel\sSubscription\sPOG;msg-param-sub-plan={ircCode};room-id=00000000;subscriber=1;system-msg={DUMMY_USERNAME}\sgifted\sa\sTier\s{tierLevel}\ssub\sto\s{DUMMY_USERNAME}_B!;tmi-sent-ts=1654696969696;user-id=00000000;user-type= :tmi.twitch.tv {KnownCommands.USERNOTICE} #{DUMMY_CHANNEL}",
                $@"@badge-info=founder/31;badges=founder/0;color=#121212;display-name={DUMMY_USERNAME};emotes=;flags=;id={GUID};login={DUMMY_USERNAME};mod=0;msg-id=subgift;msg-param-gift-months=1;msg-param-months=2;msg-param-origin-id=00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00;msg-param-recipient-display-name={DUMMY_USERNAME}_C;msg-param-recipient-id=000000000;msg-param-recipient-user-name={DUMMY_USERNAME}_C;msg-param-sender-count=0;msg-param-sub-plan-name=Channel\sSubscription\sPOG;msg-param-sub-plan={ircCode};room-id=00000000;subscriber=1;system-msg={DUMMY_USERNAME}\sgifted\sa\sTier\s{tierLevel}\ssub\sto\s{DUMMY_USERNAME}_C!;tmi-sent-ts=1654696969696;user-id=00000000;user-type= :tmi.twitch.tv {KnownCommands.USERNOTICE} #{DUMMY_CHANNEL}",
                $@"@badge-info=founder/31;badges=founder/0;color=#121212;display-name={DUMMY_USERNAME};emotes=;flags=;id={GUID};login={DUMMY_USERNAME};mod=0;msg-id=subgift;msg-param-gift-months=1;msg-param-months=8;msg-param-origin-id=00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00;msg-param-recipient-display-name={DUMMY_USERNAME}_D;msg-param-recipient-id=000000000;msg-param-recipient-user-name={DUMMY_USERNAME}_D;msg-param-sender-count=0;msg-param-sub-plan-name=Channel\sSubscription\sPOG;msg-param-sub-plan={ircCode};room-id=00000000;subscriber=1;system-msg={DUMMY_USERNAME}\sgifted\sa\sTier\s{tierLevel}\ssub\sto\s{DUMMY_USERNAME}_D!;tmi-sent-ts=1654696969696;user-id=00000000;user-type= :tmi.twitch.tv {KnownCommands.USERNOTICE} #{DUMMY_CHANNEL}",
                $@"@badge-info=founder/31;badges=founder/0;color=#121212;display-name={DUMMY_USERNAME};emotes=;flags=;id={GUID};login={DUMMY_USERNAME};mod=0;msg-id=subgift;msg-param-gift-months=1;msg-param-months=1;msg-param-origin-id=00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00;msg-param-recipient-display-name={DUMMY_USERNAME}_E;msg-param-recipient-id=000000000;msg-param-recipient-user-name={DUMMY_USERNAME}_E;msg-param-sender-count=0;msg-param-sub-plan-name=Channel\sSubscription\sPOG;msg-param-sub-plan={ircCode};room-id=00000000;subscriber=1;system-msg={DUMMY_USERNAME}\sgifted\sa\sTier\s{tierLevel}\ssub\sto\s{DUMMY_USERNAME}_E!;tmi-sent-ts=1654696969696;user-id=00000000;user-type= :tmi.twitch.tv {KnownCommands.USERNOTICE} #{DUMMY_CHANNEL}"
            );
        ...
        public async Task OnCommunityGiftSubscription_Anonymous(string tierLevel, SubPlanTypes subPlan, int ircCode)
        {
            ...
            await _client.SimulateMessagesAsync(
                @$"@badge-info=;badges=;color=;display-name=AnAnonymousGifter;emotes=;flags=;id={GUID};login=ananonymousgifter;mod=0;msg-id=submysterygift;msg-param-mass-gift-count=5;msg-param-origin-id=00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00;msg-param-sub-plan={ircCode};room-id=00000000;subscriber=0;system-msg=An\sanonymous\suser\sis\sgifting\s5\sTier\s{tierLevel}\sSubs\sto\sPOG's\scommunity!;tmi-sent-ts=1654696969696;user-id=000000000;user-type= :tmi.twitch.tv {KnownCommands.USERNOTICE} #{DUMMY_CHANNEL}",
                @$"@badge-info=;badges=;color=;display-name=AnAnonymousGifter;emotes=;flags=;id={GUID};login=ananonymousgifter;mod=0;msg-id=subgift;msg-param-fun-string=FunStringFive;msg-param-gift-months=1;msg-param-months=1;msg-param-origin-id=00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00;msg-param-recipient-display-name={DUMMY_USERNAME}_A;msg-param-recipient-id=000000000;msg-param-recipient-user-name={DUMMY_USERNAME}_A;msg-param-sub-plan-name=Channel\sSubscription\sPOG;msg-param-sub-plan={ircCode};room-id=00000000;subscriber=0;system-msg=An\sanonymous\suser\sgifted\sa\sTier\s{tierLevel}\ssub\sto\s{DUMMY_USERNAME}_A!\s;tmi-sent-ts=1654696969696;user-id=000000000;user-type= :tmi.twitch.tv {KnownCommands.USERNOTICE} #{DUMMY_CHANNEL}",
                @$"@badge-info=;badges=;color=;display-name=AnAnonymousGifter;emotes=;flags=;id={GUID};login=ananonymousgifter;mod=0;msg-id=subgift;msg-param-fun-string=FunStringThree;msg-param-gift-months=1;msg-param-months=5;msg-param-origin-id=00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00;msg-param-recipient-display-name={DUMMY_USERNAME}_B;msg-param-recipient-id=000000000;msg-param-recipient-user-name={DUMMY_USERNAME}_B;msg-param-sub-plan-name=Channel\sSubscription\sPOG;msg-param-sub-plan={ircCode};room-id=00000000;subscriber=0;system-msg=An\sanonymous\suser\sgifted\sa\sTier\s{tierLevel}\ssub\sto\s{DUMMY_USERNAME}_B!\s;tmi-sent-ts=1654696969696;user-id=000000000;user-type= :tmi.twitch.tv {KnownCommands.USERNOTICE} #{DUMMY_CHANNEL}",
                @$"@badge-info=;badges=;color=;display-name=AnAnonymousGifter;emotes=;flags=;id={GUID};login=ananonymousgifter;mod=0;msg-id=subgift;msg-param-fun-string=FunStringFour;msg-param-gift-months=1;msg-param-months=1;msg-param-origin-id=00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00;msg-param-recipient-display-name={DUMMY_USERNAME}_C;msg-param-recipient-id=000000000;msg-param-recipient-user-name={DUMMY_USERNAME}_C;msg-param-sub-plan-name=Channel\sSubscription\sPOG;msg-param-sub-plan={ircCode};room-id=00000000;subscriber=0;system-msg=An\sanonymous\suser\sgifted\sa\sTier\s{tierLevel}\ssub\sto\s{DUMMY_USERNAME}_C!\s;tmi-sent-ts=1654696969696;user-id=000000000;user-type= :tmi.twitch.tv {KnownCommands.USERNOTICE} #{DUMMY_CHANNEL}",
                @$"@badge-info=;badges=;color=;display-name=AnAnonymousGifter;emotes=;flags=;id={GUID};login=ananonymousgifter;mod=0;msg-id=subgift;msg-param-fun-string=FunStringTwo;msg-param-gift-months=1;msg-param-months=6;msg-param-origin-id=00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00;msg-param-recipient-display-name={DUMMY_USERNAME}_D;msg-param-recipient-id=000000000;msg-param-recipient-user-name={DUMMY_USERNAME}_D;msg-param-sub-plan-name=Channel\sSubscription\sPOG;msg-param-sub-plan={ircCode};room-id=00000000;subscriber=0;system-msg=An\sanonymous\suser\sgifted\sa\sTier\s{tierLevel}\ssub\sto\s{DUMMY_USERNAME}_D!\s;tmi-sent-ts=1654696969696;user-id=000000000;user-type= :tmi.twitch.tv {KnownCommands.USERNOTICE} #{DUMMY_CHANNEL}",
                @$"@badge-info=;badges=;color=;display-name=AnAnonymousGifter;emotes=;flags=;id={GUID};login=ananonymousgifter;mod=0;msg-id=subgift;msg-param-fun-string=FunStringFive;msg-param-gift-months=1;msg-param-months=9;msg-param-origin-id=00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00;msg-param-recipient-display-name={DUMMY_USERNAME}_E;msg-param-recipient-id=000000000;msg-param-recipient-user-name={DUMMY_USERNAME}_E;msg-param-sub-plan-name=Channel\sSubscription\sPOG;msg-param-sub-plan={ircCode};room-id=00000000;subscriber=0;system-msg=An\sanonymous\suser\sgifted\sa\sTier\s{tierLevel}\ssub\sto\s{DUMMY_USERNAME}_E!\s;tmi-sent-ts=1654696969696;user-id=000000000;user-type= :tmi.twitch.tv {KnownCommands.USERNOTICE} #{DUMMY_CHANNEL}"
            );
        ...
        public async Task OnContinuingGiftSubscription()
        {
            ...
            await _client.SimulateMessagesAsync(
                ...
                $"id={GUID};login={DUMMY_USERNAME};mod=0;msg-id=giftpaidupgrade;msg-param-sender-login={DUMMY_USERNAME}_Foo;msg-param-sender-name={DUMMY_USERNAME}_Foo;" +
                @$"room-id=00000000;subscriber=1;system-msg={DUMMY_USERNAME}\sis\scontinuing\sthe\sGift\sSub\sthey\sgot\sfrom\s{DUMMY_USERNAME}_Foo!;tmi-sent-ts=1654696969696;user-id=000000000;" +
                $"user-type= :tmi.twitch.tv {KnownCommands.USERNOTICE} #{DUMMY_CHANNEL}"
            );
        ...
        public async Task OnContinuingGiftSubscription_Anonymous()
        {
            ...
            await _client.SimulateMessagesAsync(
                ...
                $"id={GUID};login={DUMMY_USERNAME};mod=0;msg-id=anongiftpaidupgrade;room-id=00000000;subscriber=1;" +
                @$"system-msg={DUMMY_USERNAME}\sis\scontinuing\sthe\sGift\sSub\sthey\sgot\sfrom\san\sanonymous\suser!;tmi-sent-ts=1654696969696;user-id=000000000;" +
                $"user-type= :tmi.twitch.tv {KnownCommands.USERNOTICE} #{DUMMY_CHANNEL}"
            );
        ...
        public async Task OnPrimeUpgradeSubscription(string tierLevel, SubPlanTypes subPlan, int ircCode)
        {
            ...
            await _client.SimulateMessagesAsync(
                ...
                $"id={GUID};login={DUMMY_USERNAME};mod=0;msg-id=primepaidupgrade;msg-param-sub-plan={ircCode};room-id=00000000;subscriber=1;" +
                @$"system-msg={DUMMY_USERNAME}s\sconverted\sfrom\sa\sPrime\ssub\sto\sa\sTier\s{tierLevel}\ssub!;tmi-sent-ts=1654696969696;user-id=000000000;" +
                $"user-type= :tmi.twitch.tv {KnownCommands.USERNOTICE} #{DUMMY_CHANNEL}"
            );
        ...
        public async Task OnCommunityPayForward()
        {
            ...
            await _client.SimulateMessagesAsync(
                ...
                $"id={GUID};login={DUMMY_USERNAME};mod=0;msg-id=communitypayforward;msg-param-prior-gifter-anonymous=false;" +
                $"msg-param-prior-gifter-display-name={DUMMY_USERNAME}_Foo;msg-param-prior-gifter-id=000000000;msg-param-prior-gifter-user-name={DUMMY_USERNAME}_Foo;room-id=000000000;subscriber=1;" +
                @$"system-msg={DUMMY_USERNAME}\sis\spaying\sforward\sthe\sGift\sthey\sgot\sfrom\s{DUMMY_USERNAME}_Foo\sto\sthe\scommunity!;tmi-sent-ts=1654696969696;user-id=000000000;" +
                $"user-type= :tmi.twitch.tv {KnownCommands.USERNOTICE} #{DUMMY_CHANNEL}"
            );
        ...
        public async Task OnSubscriptionPayForward()
        {
            ...
            await _client.SimulateMessagesAsync(
                ...
                $"id={GUID};login={DUMMY_USERNAME};mod=0;msg-id=standardpayforward;msg-param-prior-gifter-anonymous=false;" +
                $"msg-param-prior-gifter-display-name={DUMMY_USERNAME}_Foo;msg-param-prior-gifter-id=000000000;msg-param-prior-gifter-user-name={DUMMY_USERNAME}_Foo;msg-param-recipient-display-name={DUMMY_USERNAME}_Bar;" +
                @$"msg-param-recipient-id=000000000;msg-param-recipient-user-name={DUMMY_USERNAME}_Bar;room-id=000000000;subscriber=1;system-msg={DUMMY_USERNAME}\sis\spaying\sforward\sthe\sGift\sthey\sgot\sfrom\s{DUMMY_USERNAME}_Foo\sto\s{DUMMY_USERNAME}_Bar!;" +
                $"tmi-sent-ts=1654696969696;user-id=000000000;user-type= :tmi.twitch.tv {KnownCommands.USERNOTICE} #{DUMMY_CHANNEL}"
            );
