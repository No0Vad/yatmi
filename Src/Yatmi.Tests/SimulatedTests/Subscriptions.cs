...
public class Subscriptions : TestBase
{
    ...
    public async Task OnGiftSubscription_Anonymous(string tierLevel, SubPlanTypes subPlan, int ircCode)
    {
        ...
        await _client.SimulateMessagesAsync(
            $"@badge-info=;badges=;color=;display-name={KnownLogins.AN_ANONYMOUS_GIFTER_DISPLAY};emotes=;flags=;id={GUID};" +
    ...
    public async Task OnCommunityGiftSubscription_Anonymous(string tierLevel, SubPlanTypes subPlan, int ircCode)
    {
        ...
        await _client.SimulateMessagesAsync(
            @$"@badge-info=;badges=;color=;display-name={KnownLogins.AN_ANONYMOUS_GIFTER_DISPLAY};emotes=;flags=;id={GUID};login={KnownLogins.AN_ANONYMOUS_GIFTER};mod=0;msg-id=submysterygift;msg-param-mass-gift-count=5;msg-param-origin-id=00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00;msg-param-sub-plan={ircCode};room-id=00000000;subscriber=0;system-msg=An\sanonymous\suser\sis\sgifting\s5\sTier\s{tierLevel}\sSubs\sto\sPOG's\scommunity!;tmi-sent-ts=1654696969696;user-id={KnownLogins.AN_ANONYMOUS_GIFTER_ID};user-type= :tmi.twitch.tv {KnownCommands.USERNOTICE} #{DUMMY_CHANNEL}",
            @$"@badge-info=;badges=;color=;display-name={KnownLogins.AN_ANONYMOUS_GIFTER_DISPLAY};emotes=;flags=;id={GUID};login={KnownLogins.AN_ANONYMOUS_GIFTER};mod=0;msg-id=subgift;msg-param-fun-string=FunStringFive;msg-param-gift-months=1;msg-param-months=1;msg-param-origin-id=00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00;msg-param-recipient-display-name={DUMMY_USERNAME}_A;msg-param-recipient-id=1{DUMMY_USER_ID};msg-param-recipient-user-name={DUMMY_USERNAME}_A;msg-param-sub-plan-name=Channel\sSubscription\sPOG;msg-param-sub-plan={ircCode};room-id=00000000;subscriber=0;system-msg=An\sanonymous\suser\sgifted\sa\sTier\s{tierLevel}\ssub\sto\s{DUMMY_USERNAME}_A!\s;tmi-sent-ts=1654696969696;user-id={KnownLogins.AN_ANONYMOUS_GIFTER_ID};user-type= :tmi.twitch.tv {KnownCommands.USERNOTICE} #{DUMMY_CHANNEL}",
            @$"@badge-info=;badges=;color=;display-name={KnownLogins.AN_ANONYMOUS_GIFTER_DISPLAY};emotes=;flags=;id={GUID};login={KnownLogins.AN_ANONYMOUS_GIFTER};mod=0;msg-id=subgift;msg-param-fun-string=FunStringThree;msg-param-gift-months=1;msg-param-months=5;msg-param-origin-id=00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00;msg-param-recipient-display-name={DUMMY_USERNAME}_B;msg-param-recipient-id=2{DUMMY_USER_ID};msg-param-recipient-user-name={DUMMY_USERNAME}_B;msg-param-sub-plan-name=Channel\sSubscription\sPOG;msg-param-sub-plan={ircCode};room-id=00000000;subscriber=0;system-msg=An\sanonymous\suser\sgifted\sa\sTier\s{tierLevel}\ssub\sto\s{DUMMY_USERNAME}_B!\s;tmi-sent-ts=1654696969696;user-id={KnownLogins.AN_ANONYMOUS_GIFTER_ID};user-type= :tmi.twitch.tv {KnownCommands.USERNOTICE} #{DUMMY_CHANNEL}",
            @$"@badge-info=;badges=;color=;display-name={KnownLogins.AN_ANONYMOUS_GIFTER_DISPLAY};emotes=;flags=;id={GUID};login={KnownLogins.AN_ANONYMOUS_GIFTER};mod=0;msg-id=subgift;msg-param-fun-string=FunStringFour;msg-param-gift-months=1;msg-param-months=1;msg-param-origin-id=00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00;msg-param-recipient-display-name={DUMMY_USERNAME}_C;msg-param-recipient-id=3{DUMMY_USER_ID};msg-param-recipient-user-name={DUMMY_USERNAME}_C;msg-param-sub-plan-name=Channel\sSubscription\sPOG;msg-param-sub-plan={ircCode};room-id=00000000;subscriber=0;system-msg=An\sanonymous\suser\sgifted\sa\sTier\s{tierLevel}\ssub\sto\s{DUMMY_USERNAME}_C!\s;tmi-sent-ts=1654696969696;user-id={KnownLogins.AN_ANONYMOUS_GIFTER_ID};user-type= :tmi.twitch.tv {KnownCommands.USERNOTICE} #{DUMMY_CHANNEL}",
            @$"@badge-info=;badges=;color=;display-name={KnownLogins.AN_ANONYMOUS_GIFTER_DISPLAY};emotes=;flags=;id={GUID};login={KnownLogins.AN_ANONYMOUS_GIFTER};mod=0;msg-id=subgift;msg-param-fun-string=FunStringTwo;msg-param-gift-months=1;msg-param-months=6;msg-param-origin-id=00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00;msg-param-recipient-display-name={DUMMY_USERNAME}_D;msg-param-recipient-id=4{DUMMY_USER_ID};msg-param-recipient-user-name={DUMMY_USERNAME}_D;msg-param-sub-plan-name=Channel\sSubscription\sPOG;msg-param-sub-plan={ircCode};room-id=00000000;subscriber=0;system-msg=An\sanonymous\suser\sgifted\sa\sTier\s{tierLevel}\ssub\sto\s{DUMMY_USERNAME}_D!\s;tmi-sent-ts=1654696969696;user-id={KnownLogins.AN_ANONYMOUS_GIFTER_ID};user-type= :tmi.twitch.tv {KnownCommands.USERNOTICE} #{DUMMY_CHANNEL}",
            @$"@badge-info=;badges=;color=;display-name={KnownLogins.AN_ANONYMOUS_GIFTER_DISPLAY};emotes=;flags=;id={GUID};login={KnownLogins.AN_ANONYMOUS_GIFTER};mod=0;msg-id=subgift;msg-param-fun-string=FunStringFive;msg-param-gift-months=1;msg-param-months=9;msg-param-origin-id=00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00\s00;msg-param-recipient-display-name={DUMMY_USERNAME}_E;msg-param-recipient-id=5{DUMMY_USER_ID};msg-param-recipient-user-name={DUMMY_USERNAME}_E;msg-param-sub-plan-name=Channel\sSubscription\sPOG;msg-param-sub-plan={ircCode};room-id=00000000;subscriber=0;system-msg=An\sanonymous\suser\sgifted\sa\sTier\s{tierLevel}\ssub\sto\s{DUMMY_USERNAME}_E!\s;tmi-sent-ts=1654696969696;user-id={KnownLogins.AN_ANONYMOUS_GIFTER_ID};user-type= :tmi.twitch.tv {KnownCommands.USERNOTICE} #{DUMMY_CHANNEL}"
        );
