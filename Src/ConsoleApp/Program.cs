...
internal static class Program
{
    ...
    internal static void Client_OnRawIrcMessage(object sender, RawIrcMessageEventArgs e)
    {
        ...
        File.AppendAllText(@"E:\Data\Yatmi\RawDump.txt", e.RawIrcMessage + Environment.NewLine);
    }
    ...
    internal static void Client_OnWhisperMessage(object sender, WhisperEventArgs e)
    {
        ...
        ColorWriteLine($"[{e.Timestamp}] <WHISPER> '{e.Username}': {e.Message}", ConsoleColor.Green);
    }
    ...
    {
        ColorWriteLine($"[{e.Timestamp}][{e.Channel}] '{e.Raider}' has raided with {e.Viewers} viewers!", ConsoleColor.Magenta);
    }
    ...
    {
        ColorWriteLine($"[{e.Timestamp}][{e.Channel}] {e.SystemMessage} | {e.Username} | {e.Months} | {e.SubPlanType}", ConsoleColor.Magenta);
    }
    ...
    {
        ColorWriteLine($"[{e.Timestamp}][{e.Channel}] {e.SystemMessage} | {e.Username} | {e.RecipientUsername} | {e.SubGiftType} | {e.SubPlanType} | {e.TotalSubsGifted} (total)", ConsoleColor.Magenta);
    }

    internal static void Client_OnCommunityGiftSubscribe(object sender, CommunityGiftSubscriptionEventArgs e)
    {
        ColorWriteLine($"[{e.Timestamp}][{e.Channel}] {e.SystemMessage} | {e.Username} | {e.SubscriptionsGifted} | {e.SubPlanType} | {e.TotalSubscriptionsGifted} (total)", ConsoleColor.Magenta);
    }

    internal static void Client_OnCommunityPayForward(object sender, CommunityPayForwardEventArgs e)
    {
        ColorWriteLine($"[{e.Timestamp}][{e.Channel}] {e.SystemMessage} | {e.Username} | {e.GifterUsername}", ConsoleColor.Magenta);
    }

    internal static void Client_OnSubscriptionPayForward(object sender, SubscriptionPayForwardEventArgs e)
    {
        ColorWriteLine($"[{e.Timestamp}][{e.Channel}] {e.SystemMessage} | {e.Username} | {e.GifterUsername} | {e.ReceiverUsername}", ConsoleColor.Magenta);
    }

    internal static void Client_OnPrimeUpgradeSubscription(object sender, PrimeUpgradeSubscriptionEventArgs e)
    {
        ColorWriteLine($"[{e.Timestamp}][{e.Channel}] {e.SystemMessage} | {e.Username} | {e.SubPlanType}", ConsoleColor.Magenta);
    }

    internal static void Client_OnSubscriptionCounter(object sender, SubscriptionCounterEventArgs e)
    {
        ColorWriteLine($"[{e.Timestamp}][{e.Channel}] {e.Username} | {e.SubscriptionCount} | {e.SubPlanType} -- COUNTER", ConsoleColor.Cyan);
    }
    ...
    {
        ColorWriteLine($"[{e.Timestamp}][{e.Channel}] {e.SystemMessage} | {e.Username}", ConsoleColor.Magenta);
    }

    internal static void Client_OnUserTimeout(object sender, UserTimeoutEventArgs e)
    {
        ColorWriteLine($"[{e.Timestamp}][{e.Channel}] {e.TimedoutUsername} was timeout! {e.Duration}", ConsoleColor.Yellow);
    }

    internal static void Client_OnUserBanned(object sender, UserBannedEventArgs e)
    {
        ColorWriteLine($"[{e.Timestamp}][{e.Channel}] {e.BannedUsername} was banned!", ConsoleColor.Red);
    }
